{
    ...
    additionalInfo: [
        ...
        { alias: "giftWrap", label: "Gift Wrap", trueValue: "Yes", falseValue: "No" , view:"boolean" },
        { alias: "giftMessage", label: "Gift Message", view:"textarea" },
        { alias: "shippingStatus", label: "Shipping Status", view:"/app_plugins/plugins/dropdown.html"}
    ]
}